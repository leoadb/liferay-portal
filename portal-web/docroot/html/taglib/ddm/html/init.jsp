...
com.liferay.dynamic.data.mapping.bridge.DDMFormValues ddmFormValues = (com.liferay.dynamic.data.mapping.bridge.DDMFormValues)request.getAttribute("ddm:html:ddmFormValues");
