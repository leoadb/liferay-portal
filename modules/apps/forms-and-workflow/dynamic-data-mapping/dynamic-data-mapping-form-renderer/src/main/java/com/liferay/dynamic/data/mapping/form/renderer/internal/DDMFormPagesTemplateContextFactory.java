...
public class DDMFormPagesTemplateContextFactory {
	...
	private DDMFormEvaluationResult _createDDMFormEvaluationResult() {
		try {
			...
			ddmFormEvaluatorContext.setDDMForm(_ddmForm);
			ddmFormEvaluatorContext.setDDMFormValues(_ddmFormValues);
			ddmFormEvaluatorContext.setHttpServletRequest(
				_ddmFormRenderingContext.getHttpServletRequest());
			ddmFormEvaluatorContext.setLocale(_locale);
