 ...
 * @hassoydeltemplate {ddm.del_form_rows}
...
ddm.__deltemplate_s3_8babfdd0 = function(opt_data, opt_ignored) {
  return '' + ddm.form_rows(opt_data);
};
if (goog.DEBUG) {
  ddm.__deltemplate_s3_8babfdd0.soyTemplateName = 'ddm.__deltemplate_s3_8babfdd0';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ddm.del_form_rows'), '', 0, ddm.__deltemplate_s3_8babfdd0);


ddm.fields = function(opt_data, opt_ignored) {
  var output = '';
  var fieldList14 = opt_data.fields;
  ...
  for (var fieldIndex14 = 0; fieldIndex14 < fieldListLen14; fieldIndex14++) {
    ...
    var variant__soy6 = fieldData14.type;
    output += '<div class="clearfix ' + ((! fieldData14.visible) ? 'hide' : '') + ' lfr-ddm-form-field-container">' + soy.$$getDelegateFn(soy.$$getDelTemplateId('ddm.field'), variant__soy6, true)(fieldData14) + '</div>';
  }
  return output;
};
if (goog.DEBUG) {
