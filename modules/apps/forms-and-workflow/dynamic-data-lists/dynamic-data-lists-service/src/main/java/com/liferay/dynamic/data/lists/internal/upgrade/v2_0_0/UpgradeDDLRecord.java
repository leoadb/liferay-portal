...
package com.liferay.dynamic.data.lists.internal.upgrade.v2_0_0;
...
public class UpgradeDDLRecord extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		...
		sql.append("select DDLRecord.* from DDLRecord ");
		sql.append("inner join DDMFormInstance on DDLRecord.recordSetId ");
