...
public class UpgradeDDLRecordSetSettings extends UpgradeProcess {
	...
	protected void convertToJSONArrayValue(
		...
		if (fieldJSONObject == null) {
			jsonArrayValue.put(defaultValue);
		}
		else {
			jsonArrayValue.put(fieldJSONObject.getString("value"));
		}
	...
	protected void updateSettings(JSONObject settingsJSONObject) {
		convertToJSONArrayValue(
			settingsJSONObject.getJSONObject("storageType"), "json");
		convertToJSONArrayValue(
			settingsJSONObject.getJSONObject("workflowDefinition"),
			"no-workflow");
	}
