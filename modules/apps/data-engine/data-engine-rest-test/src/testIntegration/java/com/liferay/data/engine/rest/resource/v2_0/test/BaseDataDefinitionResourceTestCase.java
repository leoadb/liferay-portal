...
public abstract class BaseDataDefinitionResourceTestCase {
	...
	public void testGetInstanceDataDefinitionsPage() throws Exception {
		...
		Long instanceId = testGetInstanceDataDefinitionsPage_getInstanceId();
		Long irrelevantInstanceId =
			testGetInstanceDataDefinitionsPage_getIrrelevantInstanceId();

		if ((irrelevantInstanceId != null)) {
			DataDefinition irrelevantDataDefinition =
				testGetInstanceDataDefinitionsPage_addDataDefinition(
					irrelevantInstanceId, randomIrrelevantDataDefinition());

			page = dataDefinitionResource.getInstanceDataDefinitionsPage(
				irrelevantInstanceId, null, null, Pagination.of(1, 2), null);
		...
		DataDefinition dataDefinition1 =
			testGetInstanceDataDefinitionsPage_addDataDefinition(
				instanceId, randomDataDefinition());
		...
		page = dataDefinitionResource.getInstanceDataDefinitionsPage(
			instanceId, null, null, Pagination.of(1, 2), null);
	...
	@Test
	public void testGetInstanceDataDefinitionsPageWithPagination()
		throws Exception {
		...
		Page<DataDefinition> page2 =
			dataDefinitionResource.getInstanceDataDefinitionsPage(
				instanceId, null, null, Pagination.of(2, 2), null);
		...
		Page<DataDefinition> page3 =
			dataDefinitionResource.getInstanceDataDefinitionsPage(
				instanceId, null, null, Pagination.of(1, 3), null);
	...
	@Test
	public void testGetInstanceDataDefinitionsPageWithSortDateTime()
		throws Exception {

		testGetInstanceDataDefinitionsPageWithSort(
	...
	@Test
	public void testGetInstanceDataDefinitionsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetInstanceDataDefinitionsPageWithSortString()
		throws Exception {
	...
	protected void testGetInstanceDataDefinitionsPageWithSort(
		...
		dataDefinition1 = testGetInstanceDataDefinitionsPage_addDataDefinition(
			instanceId, dataDefinition1);

		dataDefinition2 = testGetInstanceDataDefinitionsPage_addDataDefinition(
			instanceId, dataDefinition2);

		for (EntityField entityField : entityFields) {
			Page<DataDefinition> ascPage =
				dataDefinitionResource.getInstanceDataDefinitionsPage(
					instanceId, null, null, Pagination.of(1, 2),
	...
	protected Long testGetInstanceDataDefinitionsPage_getIrrelevantInstanceId()
		throws Exception {
	...
	@Test
	public void testPostInstanceDataDefinition() throws Exception {
		DataDefinition randomDataDefinition = randomDataDefinition();

		DataDefinition postDataDefinition =
			testPostInstanceDataDefinition_addDataDefinition(
	...
	protected DataDefinition testPostInstanceDataDefinition_addDataDefinition(
			DataDefinition dataDefinition)
		throws Exception {

		return dataDefinitionResource.postInstanceDataDefinition(
			testGetInstanceDataDefinitionsPage_getInstanceId(), dataDefinition);
	}
	...
	@Test
	public void testGraphQLGetInstanceDataDefinition() throws Exception {
		DataDefinition dataDefinition =
			testGraphQLDataDefinition_addDataDefinition();
		...
		GraphQLField graphQLField = new GraphQLField(
			"query",
			new GraphQLField(
				"instanceDataDefinition",
				new HashMap<String, Object>() {
					{
						put("instanceId", dataDefinition.getInstanceId());
						put(
							"dataDefinitionKey",
		...
		Assert.assertTrue(
			equalsJSONObject(
				dataDefinition,
				dataJSONObject.getJSONObject("instanceDataDefinition")));
	}
	...
	protected void assertValid(DataDefinition dataDefinition) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("instanceId", additionalAssertFieldName)) {
				if (dataDefinition.getInstanceId() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("instanceId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						dataDefinition1.getInstanceId(),
						dataDefinition2.getInstanceId())) {
