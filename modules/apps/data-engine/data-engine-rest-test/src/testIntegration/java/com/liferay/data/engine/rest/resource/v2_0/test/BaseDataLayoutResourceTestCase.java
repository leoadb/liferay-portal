...
public abstract class BaseDataLayoutResourceTestCase {
	...
	@Test
	public void testGetDataLayoutsPage() throws Exception {
		Page<DataLayout> page = dataLayoutResource.getDataLayoutsPage(
			RandomTestUtil.randomString(), RandomTestUtil.randomString(),
			Pagination.of(1, 2), null);

		Assert.assertEquals(0, page.getTotalCount());

		DataLayout dataLayout1 = testGetDataLayoutsPage_addDataLayout(
			randomDataLayout());

		DataLayout dataLayout2 = testGetDataLayoutsPage_addDataLayout(
			randomDataLayout());

		page = dataLayoutResource.getDataLayoutsPage(
	...
	@Test
	public void testGetDataLayoutsPageWithPagination() throws Exception {
		DataLayout dataLayout1 = testGetDataLayoutsPage_addDataLayout(
			randomDataLayout());
		...
		DataLayout dataLayout3 = testGetDataLayoutsPage_addDataLayout(
			randomDataLayout());

		Page<DataLayout> page1 = dataLayoutResource.getDataLayoutsPage(
			null, null, Pagination.of(1, 2), null);
		...
		Page<DataLayout> page2 = dataLayoutResource.getDataLayoutsPage(
		...
		Page<DataLayout> page3 = dataLayoutResource.getDataLayoutsPage(
	...
	@Test
	public void testGetDataLayoutsPageWithSortDateTime() throws Exception {
		testGetDataLayoutsPageWithSort(
			EntityField.Type.DATE_TIME,
			(entityField, dataLayout1, dataLayout2) -> {
				BeanUtils.setProperty(
					dataLayout1, entityField.getName(),
	...
	@Test
	public void testGetDataLayoutsPageWithSortInteger() throws Exception {
		testGetDataLayoutsPageWithSort(
			EntityField.Type.INTEGER,
			(entityField, dataLayout1, dataLayout2) -> {
				BeanUtils.setProperty(dataLayout1, entityField.getName(), 0);
	...
	@Test
	public void testGetDataLayoutsPageWithSortString() throws Exception {
		testGetDataLayoutsPageWithSort(
			EntityField.Type.STRING,
			(entityField, dataLayout1, dataLayout2) -> {
				Class<?> clazz = dataLayout1.getClass();
	...
	protected void testGetDataLayoutsPageWithSort(
			EntityField.Type type,
			UnsafeTriConsumer<EntityField, DataLayout, DataLayout, Exception>
				unsafeTriConsumer)
		throws Exception {
		...
		dataLayout1 = testGetDataLayoutsPage_addDataLayout(dataLayout1);

		dataLayout2 = testGetDataLayoutsPage_addDataLayout(dataLayout2);

		for (EntityField entityField : entityFields) {
			Page<DataLayout> ascPage = dataLayoutResource.getDataLayoutsPage(
			...
			Page<DataLayout> descPage = dataLayoutResource.getDataLayoutsPage(
				null, null, Pagination.of(1, 2),
				entityField.getName() + ":desc");
	...
	protected DataLayout testGetDataLayoutsPage_addDataLayout(
			DataLayout dataLayout)
		throws Exception {
	...
	@Test
	public void testGraphQLGetDataLayoutsPage() throws Exception {
