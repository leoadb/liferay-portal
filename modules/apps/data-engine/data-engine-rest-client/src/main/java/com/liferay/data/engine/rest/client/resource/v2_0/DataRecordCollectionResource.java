...
public interface DataRecordCollectionResource {
	...
	public Page<DataRecordCollection> getDataRecordCollectionsPage(
			String dataRecordCollectionKey, String keywords,
			Pagination pagination)
		throws Exception;

	public HttpInvoker.HttpResponse getDataRecordCollectionsPageHttpResponse(
			String dataRecordCollectionKey, String keywords,
			Pagination pagination)
		throws Exception;
	...
	public static class DataRecordCollectionResourceImpl
		...
		public Page<DataRecordCollection> getDataRecordCollectionsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDataRecordCollectionsPageHttpResponse(
					dataRecordCollectionKey, keywords, pagination);
		...
		public HttpInvoker.HttpResponse
			...
			if (dataRecordCollectionKey != null) {
				httpInvoker.parameter(
					...
					String.valueOf(dataRecordCollectionKey));
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/data-engine/v2.0/data-record-collections");
