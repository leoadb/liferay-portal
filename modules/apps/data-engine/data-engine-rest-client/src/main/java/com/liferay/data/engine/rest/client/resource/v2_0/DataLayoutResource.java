...
public interface DataLayoutResource {
	...
	public Page<DataLayout> getDataLayoutsPage(
			String dataLayoutKey, String keywords, Pagination pagination,
			String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse getDataLayoutsPageHttpResponse(
			String dataLayoutKey, String keywords, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public static class DataLayoutResourceImpl implements DataLayoutResource {
		...
		public Page<DataLayout> getDataLayoutsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDataLayoutsPageHttpResponse(
					dataLayoutKey, keywords, pagination, sortString);
		...
		public HttpInvoker.HttpResponse getDataLayoutsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/data-engine/v2.0/data-layouts");
