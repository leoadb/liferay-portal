...
public interface DataDefinitionResource {
	...
	public Page<DataDefinition> getDataDefinitionsPage(
			String contentSpace, String dataDefinitionKey, String keywords,
			Pagination pagination, String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse getDataDefinitionsPageHttpResponse(
			String contentSpace, String dataDefinitionKey, String keywords,
			Pagination pagination, String sortString)
		throws Exception;

	public DataDefinition postDataDefinition(
			String contentSpace, DataDefinition dataDefinition)
		throws Exception;

	public HttpInvoker.HttpResponse postDataDefinitionHttpResponse(
			String contentSpace, DataDefinition dataDefinition)
		throws Exception;
	...
	public static class DataDefinitionResourceImpl
		...
		public Page<DataDefinition> getDataDefinitionsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDataDefinitionsPageHttpResponse(
					contentSpace, dataDefinitionKey, keywords, pagination,
					sortString);
		...
		public HttpInvoker.HttpResponse getDataDefinitionsPageHttpResponse(
			...
			if (contentSpace != null) {
				httpInvoker.parameter(
					"contentSpace", String.valueOf(contentSpace));
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/data-engine/v2.0/data-definitions");
		...
		public DataDefinition postDataDefinition(
			...
			HttpInvoker.HttpResponse httpResponse =
				postDataDefinitionHttpResponse(contentSpace, dataDefinition);
