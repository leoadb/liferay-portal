...
public interface DataDefinitionResource {
	...
	public Page<DataDefinition> getDataDefinitionsPage(
			Long classNameId, String dataDefinitionKey, String keywords,
	...
	public static class DataDefinitionResourceImpl
		...
		public Page<DataDefinition> getDataDefinitionsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDataDefinitionsPageHttpResponse(
					classNameId, dataDefinitionKey, keywords, pagination,
					sortString);
		...
		public DataDefinition postDataDefinition(DataDefinition dataDefinition)
			...
			HttpInvoker.HttpResponse httpResponse =
				postDataDefinitionHttpResponse(dataDefinition);
