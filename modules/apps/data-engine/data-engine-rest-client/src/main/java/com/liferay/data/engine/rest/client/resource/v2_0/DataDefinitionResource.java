...
public interface DataDefinitionResource {
	...
	public HttpInvoker.HttpResponse getInstanceDataDefinitionsPageHttpResponse(
			Long instanceId, Long classNameId, String keywords,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postInstanceDataDefinitionHttpResponse(
			Long instanceId, DataDefinition dataDefinition)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getInstanceDataDefinitionHttpResponse(
			Long instanceId, String dataDefinitionKey, Long classNameId)
		throws Exception;
	...
	public static class DataDefinitionResourceImpl
		...
		public Page<DataDefinition> getInstanceDataDefinitionsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getInstanceDataDefinitionsPageHttpResponse(
					instanceId, classNameId, keywords, pagination, sortString);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/data-engine/v2.0/instances/{instanceId}/data-definitions",
				instanceId);
		...
		public DataDefinition postInstanceDataDefinition(
			...
			HttpInvoker.HttpResponse httpResponse =
				postInstanceDataDefinitionHttpResponse(
		...
		public DataDefinition getInstanceDataDefinition(
			...
			HttpInvoker.HttpResponse httpResponse =
				getInstanceDataDefinitionHttpResponse(
		...
		public HttpInvoker.HttpResponse getInstanceDataDefinitionHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/data-engine/v2.0/instances/{instanceId}/data-definitions/{dataDefinitionKey}",
				instanceId, dataDefinitionKey);
