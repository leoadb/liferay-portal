...
public class DataDefinitionLocalServiceTest {
	...
	public void testGetList() throws Exception {
		...
		DataDefinition dataDefinition1 = DataDefinition.Builder.newBuilder(
			Arrays.asList(dataDefinitionColumn)
		).name(
			LocaleUtil.US, "Definition 1"
		).storageType(
		...
		DataDefinition dataDefinition2 = DataDefinition.Builder.newBuilder(
			Arrays.asList(dataDefinitionColumn)
		).name(
			LocaleUtil.US, "Definition 2"
		).storageType(
		...
		try {
			...
			dataDefinition1.setPrimaryKeyObj(
			...
			dataDefinition2.setPrimaryKeyObj(
