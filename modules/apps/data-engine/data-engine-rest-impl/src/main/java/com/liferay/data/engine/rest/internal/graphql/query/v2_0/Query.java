...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {instanceDataDefinitions(classNameId: ___, instanceId: ___, keywords: ___, page: ___, pageSize: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public DataDefinitionPage instanceDataDefinitions(
		...
		return _applyComponentServiceObjects(
			...
			dataDefinitionResource -> new DataDefinitionPage(
				dataDefinitionResource.getInstanceDataDefinitionsPage(
					instanceId, classNameId, keywords,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {instanceDataDefinition(classNameId: ___, dataDefinitionKey: ___, instanceId: ___){availableLanguageIds, classNameId, dataDefinitionFields, dataDefinitionKey, dataDefinitionRules, dateCreated, dateModified, defaultLanguageId, description, id, instanceId, name, siteId, storageType, userId}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public DataDefinition instanceDataDefinition(
			@GraphQLName("instanceId") Long instanceId,
		...
		return _applyComponentServiceObjects(
			...
			dataDefinitionResource ->
				dataDefinitionResource.getInstanceDataDefinition(
					instanceId, dataDefinitionKey, classNameId));
	}
