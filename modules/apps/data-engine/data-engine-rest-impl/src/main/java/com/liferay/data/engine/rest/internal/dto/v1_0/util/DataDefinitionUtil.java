...
public class DataDefinitionUtil {
	...
	public static DDMForm toDDMForm(DataDefinition dataDefinition) {
		DDMForm ddmForm = new DDMForm();

		ddmForm.setAvailableLocales(
			_toLocales(dataDefinition.getAvailableLanguageIds()));
		ddmForm.setDDMFormFields(
			_toDDMFormFields(dataDefinition.getDataDefinitionFields()));
	...
	private static List<DDMFormField> _toDDMFormFields(
		...
		return Stream.of(
			...
			DataDefinitionUtil::_toDDMFormField
		).collect(
			Collectors.toList()
		);
	}
