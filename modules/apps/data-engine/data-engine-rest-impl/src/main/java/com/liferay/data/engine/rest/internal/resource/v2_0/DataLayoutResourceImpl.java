...
import com.liferay.data.engine.exception.DEDataLayoutColumnSizeException;
import com.liferay.data.engine.exception.DEDataLayoutDefaultLocaleException;
import com.liferay.data.engine.exception.DEDataLayoutException;
import com.liferay.data.engine.exception.DEDataLayoutLocaleForLayoutAndTitleException;
import com.liferay.data.engine.exception.DEDataLayoutRowSizeException;
import com.liferay.data.engine.exception.DuplicateDEDataLayoutFieldNameException;
...
public class DataLayoutResourceImpl
	...
	private DEDataLayoutException _toDataLayoutException(
		...
		if (ddmFormLayoutValidationException instanceof
			...
			return new DEDataLayoutColumnSizeException(
		...
		if (ddmFormLayoutValidationException instanceof
			...
			return new DEDataLayoutRowSizeException(
				ddmFormLayoutValidationException);
		}
		...
		if (ddmFormLayoutValidationException instanceof
			...
			return new DuplicateDEDataLayoutFieldNameException(
		...
		if (ddmFormLayoutValidationException instanceof
			...
			return new DEDataLayoutDefaultLocaleException(
				ddmFormLayoutValidationException);
		}
		...
		if (ddmFormLayoutValidationException instanceof
			...
			return new DEDataLayoutLocaleForLayoutAndTitleException(
				ddmFormLayoutValidationException);
		}

		return new DEDataLayoutException(
	...
	private void _validate(DataLayout dataLayout, DDMStructure ddmStructure)
		...
		try {
			...
			throw new DEDataLayoutException(exception);
		}
	}
