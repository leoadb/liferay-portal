...
public class DataDefinitionResourceImpl extends BaseDataDefinitionResourceImpl {
	...
	public DataDefinition postDataDefinition(
		...
		DataEngineContentSpace dataEngineContentSpace =
			_dataEngineContentSpaceTracker.getContentSpace(contentSpace);
		...
		saveDataDefinitionRequest.setDEDataDefinition(
			toDEDataDefinition(
				dataEngineContentSpace.getClassNameId(), dataDefinition,
	...
	protected DEDataDefinition toDEDataDefinition(
		long classNameId, DataDefinition dataDefinition, long instanceId) {

		return DEDataDefinition.newBuilder(
			classNameId, instanceId,
	...
	@Reference
	private DataEngineContentSpaceTracker _dataEngineContentSpaceTracker;
