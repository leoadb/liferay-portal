...
public class DERadioFieldTypeTest extends DEBaseFieldTypeTest {
	...
	public void testGetFieldProperties() throws Exception {
		...
		DERadioFieldType deRadioFieldType = new DERadioFieldType();

		field(
			DERadioFieldType.class, "jsonFactory"
		).set(
			deRadioFieldType, new JSONFactoryImpl()
		);

		DEFieldTypeGetContextResponse deFieldTypeGetFieldPropertiesResponse =
			deRadioFieldType.getContext(deFieldTypeGetFieldPropertiesRequest);
