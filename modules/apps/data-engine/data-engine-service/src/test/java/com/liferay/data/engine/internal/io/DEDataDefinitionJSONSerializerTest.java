...
import com.liferay.data.engine.model.DEDataDefinitionValidationRuleFactory;
...
public class DEDataDefinitionJSONSerializerTest extends BaseTestCase {
	...
	public void testApply() throws Exception {
		...
		DEDataDefinitionValidationRule deDataDefinitionValidationRule1 =
			DEDataDefinitionValidationRuleFactory.emailAddress(
				Arrays.asList("email"));

		DEDataDefinitionValidationRule deDataDefinitionValidationRule2 =
			DEDataDefinitionValidationRuleFactory.required(
				Arrays.asList("name"));

		DEDataDefinitionValidationRule deDataDefinitionValidationRule3 =
			DEDataDefinitionValidationRuleFactory.matchExpression(
				"^[0-9]+(\\.[0-9]{1,2})?", Arrays.asList("salary"));
		...
		deDataDefinition.setDEDataDefinitionValidationRules(
			Arrays.asList(
				deDataDefinitionValidationRule1,
				deDataDefinitionValidationRule2,
				deDataDefinitionValidationRule3));

		DEDataDefinitionSerializerApplyRequest.Builder builder =
			DEDataDefinitionSerializerApplyRequest.Builder.newBuilder(
				deDataDefinition);

		DEDataDefinitionJSONSerializer deDataDefinitionFieldsJSONSerializer =
			new DEDataDefinitionJSONSerializer();
