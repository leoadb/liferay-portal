...
public class DEDataDefinitionJSONSerializer
	...
	public DEDataDefinitionSerializerApplyResponse apply(
		...
		if (!deDataDefinitionValidationRules.isEmpty()) {
			jsonObject.put(
				"validationRules",
				getDEDataDefinitionValidationRulesJSONArray(
	...
	protected JSONObject getDEDataDefinitionValidationRuleObject(
		...
		jsonObject.put("name", deDataDefinitionValidationRule.getName());
	...
	protected JSONArray getDEDataDefinitionValidationRulesJSONArray(
		List<DEDataDefinitionValidationRule> deDataDefinitionValidationRules) {

		JSONArray jsonArray = jsonFactory.createJSONArray();

		Stream<DEDataDefinitionValidationRule> stream =
			deDataDefinitionValidationRules.stream();

		stream.map(
			this::getDEDataDefinitionValidationRuleObject
		).forEach(
			jsonArray::put
		);
