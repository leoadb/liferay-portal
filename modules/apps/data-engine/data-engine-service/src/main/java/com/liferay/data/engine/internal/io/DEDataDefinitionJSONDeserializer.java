...
public class DEDataDefinitionJSONDeserializer
			...
			if (jsonObject.has("validationRules")) {
				deDataDefinition.setDEDataDefinitionValidationRules(
					getDEDataDefinitionValidationRules(
						jsonObject.getJSONArray("validationRules")));
			}
	...
	protected DEDataDefinitionValidationRule getDEDataDefinitionValidationRule(
		JSONObject jsonObject) {
	...
	protected List<DEDataDefinitionValidationRule>
		getDEDataDefinitionValidationRules(JSONArray jsonArray) {
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			DEDataDefinitionValidationRule deDataDefinitionValidationRule =
				getDEDataDefinitionValidationRule(jsonArray.getJSONObject(i));

			deDataDefinitionValidationRules.add(deDataDefinitionValidationRule);
		}

		return deDataDefinitionValidationRules;
	}
