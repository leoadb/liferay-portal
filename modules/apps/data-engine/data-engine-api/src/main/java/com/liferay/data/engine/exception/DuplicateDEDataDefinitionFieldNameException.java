 ...
 */
public class DuplicateDEDataDefinitionFieldNameException extends PortalException {
	...
	public DuplicateDEDataDefinitionFieldNameException(String msg, Throwable cause) {
		super(msg, cause);
	}
