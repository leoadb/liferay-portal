 ...
 */
@ProviderType
public interface DEDataLayoutPageBuilder {

	public DEDataLayoutPage build();

	public DEDataLayoutPageBuilder description(Map<String, Object> description);

	public DEDataLayoutPageBuilder rows(List<DEDataLayoutRow> deDataLayoutRows);
