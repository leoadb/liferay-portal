 ...
 */
public class DataDefinitionValidationExpressionException extends PortalException {
	...
	public DataDefinitionValidationExpressionException(String msg, Throwable cause) {
		super(msg, cause);
	}
