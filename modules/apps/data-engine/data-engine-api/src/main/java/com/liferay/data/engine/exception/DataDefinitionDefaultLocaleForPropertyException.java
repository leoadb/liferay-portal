 ...
 */
public class DataDefinitionDefaultLocaleForPropertyException extends PortalException {
	...
	public DataDefinitionDefaultLocaleForPropertyException(String msg, Throwable cause) {
		super(msg, cause);
	}
