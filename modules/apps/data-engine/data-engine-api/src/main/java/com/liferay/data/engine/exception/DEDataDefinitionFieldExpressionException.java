 ...
 */
public class DEDataDefinitionFieldExpressionException extends PortalException {
	...
	public DEDataDefinitionFieldExpressionException(String msg, Throwable cause) {
		super(msg, cause);
	}
