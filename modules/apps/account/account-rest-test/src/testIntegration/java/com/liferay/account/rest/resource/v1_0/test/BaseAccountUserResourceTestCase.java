...
public abstract class BaseAccountUserResourceTestCase {
	...
	public void testGetAccountUsersPage() throws Exception {
		...
		accountUserList.add(accountUser1);
	...
	public void testGetAccountUsersPageWithPagination() throws Exception {
		...
		accountUserList.add(accountUser3);
	...
	public void testPostAccountUser() throws Exception {
		...
		accountUserList.add(postAccountUser);
	...
	protected void assertEqualsJSONArray(
		List<AccountUser> accountUsers, JSONArray jsonArray) {

		for (AccountUser accountUser : accountUsers) {
			boolean contains = false;

			for (Object object : jsonArray) {
				if (equalsJSONObject(accountUser, (JSONObject)object)) {
					contains = true;
			...
			Assert.assertTrue(
				jsonArray + " does not contain " + accountUser, contains);
		}
	}
	...
	protected boolean equalsJSONObject(
		AccountUser accountUser, JSONObject jsonObject) {
		...
		for (String fieldName : getAdditionalAssertFieldNames()) {
			...
			if (Objects.equals("id", fieldName)) {
				if (!Objects.deepEquals(
						accountUser.getId(), jsonObject.getLong("id"))) {
			...
			if (Objects.equals("prefix", fieldName)) {
				if (!Objects.deepEquals(
			...
			if (Objects.equals("screenName", fieldName)) {
				if (!Objects.deepEquals(
						accountUser.getScreenName(),
			...
			if (Objects.equals("suffix", fieldName)) {
				if (!Objects.deepEquals(
	...
	protected List<AccountUser> accountUserList;
