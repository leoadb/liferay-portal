...
import com.liferay.report.definitions.web.internal.portlet.action.forms.AvailableColumnsForm;
...
public class ReportDefinitionsDisplayContext {
	...
	public String getColumnsFormHTML() throws Exception {
		DataLayoutRendererContext dataLayoutRendererContext =
			new DataLayoutRendererContext();

		dataLayoutRendererContext.setContainerId("reportsContainer");
		dataLayoutRendererContext.setHttpServletRequest(
			_reportDefinitionsRequestHelper.getRequest());
		...
		dataLayoutRendererContext.setPortletNamespace(
			_portal.getPortletNamespace(
				ReportDefinitionPortletKeys.PORTLET_NAME));

		return _dataLayoutRenderer.render(
			AvailableColumnsForm.class, dataLayoutRendererContext);
	}
