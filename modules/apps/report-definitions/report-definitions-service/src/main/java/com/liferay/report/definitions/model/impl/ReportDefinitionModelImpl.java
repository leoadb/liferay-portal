...
public class ReportDefinitionModelImpl extends BaseModelImpl<ReportDefinition>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(report.definitions.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.report.definitions.model.ReportDefinition"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(report.definitions.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.report.definitions.model.ReportDefinition"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(report.definitions.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(report.definitions.service.util.ServiceProps.get(
	...
	public CacheModel<ReportDefinition> toCacheModel() {
		...
		reportDefinitionCacheModel.parametersDataSchemaId = getParametersDataSchemaId();
	...
	public String toString() {
		...
		sb.append(getParametersDataSchemaId());
		sb.append(", sortColumns=");
		sb.append(getSortColumns());
		sb.append("}");
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>parametersDataSchemaId</column-name><column-value><![CDATA[");
		sb.append(getParametersDataSchemaId());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>sortColumns</column-name><column-value><![CDATA[");
		sb.append(getSortColumns());
		sb.append("]]></column-value></column>");
