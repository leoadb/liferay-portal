...
public class ReportDefinitionModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"dataDefinitionId", Types.BIGINT}, {"dataLayoutId", Types.BIGINT},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("dataLayoutId", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("description", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("name", Types.VARCHAR);
	}

	public static final String TABLE_SQL_CREATE =
		"create table ReportDefinition (uuid_ VARCHAR(75) null,reportDefinitionId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,columnsDDMContentId LONG,dataDefinitionId LONG,dataLayoutId LONG,description VARCHAR(75) null,name VARCHAR(75) null)";
	...
	static {
		...
		attributeGetterFunctions.put(
			...
			new Function<ReportDefinition, Object>() {
				...
				@Override
				public Object apply(ReportDefinition reportDefinition) {
					return reportDefinition.getColumnsDDMContentId();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ReportDefinition, Object>() {
				...
				public void accept(
					ReportDefinition reportDefinition,
					Object columnsDDMContentId) {

					reportDefinition.setColumnsDDMContentId(
		...
		attributeGetterFunctions.put(
			...
			new Function<ReportDefinition, Object>() {
				...
				@Override
				public Object apply(ReportDefinition reportDefinition) {
					return reportDefinition.getDataLayoutId();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ReportDefinition, Object>() {
				...
				@Override
				public void accept(
					ReportDefinition reportDefinition, Object dataLayoutId) {

					reportDefinition.setDataLayoutId((Long)dataLayoutId);
				}
	...
	public ReportDefinition toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (ReportDefinition)ProxyUtil.newProxyInstance(
	...
	public Object clone() {
		...
		reportDefinitionImpl.setDataLayoutId(getDataLayoutId());
	...
	public CacheModel<ReportDefinition> toCacheModel() {
		...
		reportDefinitionCacheModel.columnsDDMContentId =
			getColumnsDDMContentId();

		reportDefinitionCacheModel.dataDefinitionId = getDataDefinitionId();

		reportDefinitionCacheModel.dataLayoutId = getDataLayoutId();
	...
	private static final ClassLoader _classLoader =
		ReportDefinition.class.getClassLoader();
