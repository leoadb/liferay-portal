...
public class ReportDefinitionCacheModel implements CacheModel<ReportDefinition>,
	...
	public String toString() {
		...
		sb.append(", name=");
		sb.append(name);
		sb.append(", parametersDataSchemaId=");
		sb.append(parametersDataSchemaId);
	...
	public ReportDefinition toEntityModel() {
		...
		reportDefinitionImpl.setParametersDataSchemaId(parametersDataSchemaId);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		parametersDataSchemaId = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(parametersDataSchemaId);
