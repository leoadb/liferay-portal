...
public class DDMBeanCopyUtil {
	...
	public static DDMFormValues copyDDMFormValues(
		...
		for (com.liferay.portlet.dynamicdatamapping.storage.DDMFormFieldValue
			...
			formValues.addDDMFormFieldValue(
				copyDDMFormFieldValue(ddmFormFieldValue, formValues));
		}
	...
	private static DDMFormFieldValue copyDDMFormFieldValue(
		com.liferay.portlet.dynamicdatamapping.storage.DDMFormFieldValue
			ddmFormFieldValue, DDMFormValues formValues) {
		...
		formFieldValue.setDDMFormValues(formValues);
		...
		for (com.liferay.portlet.dynamicdatamapping.storage.DDMFormFieldValue
			...
			formValues.addDDMFormFieldValue(
				copyDDMFormFieldValue(nestedFormFieldValue, formValues));
		}
	...
	private static UnlocalizedValue copyUnlocalizedValue(
		...
		unlocalizedValue.setDefaultLocale(value.getDefaultLocale());
