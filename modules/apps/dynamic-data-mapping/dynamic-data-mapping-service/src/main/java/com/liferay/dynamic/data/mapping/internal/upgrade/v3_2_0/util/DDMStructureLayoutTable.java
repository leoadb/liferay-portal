...
package com.liferay.dynamic.data.mapping.internal.upgrade.v3_2_0.util;
...
public class DDMStructureLayoutTable {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"classNameId", Types.BIGINT}, {"structureVersionId", Types.BIGINT},
		{"name", Types.CLOB}, {"description", Types.CLOB},
		{"definition", Types.CLOB}, {"structureLayoutKey", Types.VARCHAR}
	};
...
"create table DDMStructureLayout (uuid_ VARCHAR(75) null,structureLayoutId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,classNameId LONG,structureVersionId LONG,name TEXT null,description TEXT null,definition TEXT null,structureLayoutKey VARCHAR(75) null)";
