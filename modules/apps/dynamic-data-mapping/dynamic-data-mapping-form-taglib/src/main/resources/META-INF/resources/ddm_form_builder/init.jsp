...
boolean useExperimentalInterface = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay-form:ddm-form-builder:useExperimentalInterface")), true);
