...
page import="com.liferay.dynamic.data.mapping.web.portlet.search.StructureDisplayTerms" %><%@
page import="com.liferay.dynamic.data.mapping.web.portlet.search.StructureSearch" %><%@
page import="com.liferay.dynamic.data.mapping.web.portlet.search.StructureSearchTerms" %><%@
page import="com.liferay.dynamic.data.mapping.web.portlet.search.TemplateDisplayTerms" %><%@
page import="com.liferay.dynamic.data.mapping.web.portlet.search.TemplateSearch" %><%@
page import="com.liferay.dynamic.data.mapping.web.portlet.search.TemplateSearchTerms" %><%@
