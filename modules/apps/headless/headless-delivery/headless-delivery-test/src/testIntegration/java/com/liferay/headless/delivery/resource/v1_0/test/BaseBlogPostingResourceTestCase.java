...
public abstract class BaseBlogPostingResourceTestCase {
	...
	public void testGetBlogPosting() throws Exception {
		...
		blogPostings.add(postBlogPosting);
	...
	protected List<BlogPosting> blogPostings;
