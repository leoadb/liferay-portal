...
public abstract class BaseMessageBoardSectionResourceTestCase {
	...
	public void setUp() throws Exception {
		messageBoardSectionList = new ArrayList<>();
	...
	public void tearDown() throws Exception {
		for (MessageBoardSection messageBoardSection :
				messageBoardSectionList) {

			try {
				deleteMessageBoardSection(messageBoardSection);
			}
	...
	public void testDeleteMessageBoardSection() throws Exception {
		...
		messageBoardSectionList.add(messageBoardSection);
	...
	public void testGetMessageBoardSection() throws Exception {
		...
		messageBoardSectionList.add(postMessageBoardSection);
	...
	public void testGetMessageBoardSectionMessageBoardSectionsPage()
		...
		messageBoardSectionList.add(messageBoardSection1);

		MessageBoardSection messageBoardSection2 =
			testGetMessageBoardSectionMessageBoardSectionsPage_addMessageBoardSection(
				parentMessageBoardSectionId, randomMessageBoardSection());

		messageBoardSectionList.add(messageBoardSection2);
	...
	public void testGetMessageBoardSectionMessageBoardSectionsPageWithPagination()
		...
		messageBoardSectionList.add(messageBoardSection3);
	...
	protected void deleteMessageBoardSection(
			MessageBoardSection messageBoardSection)
		throws Exception {
	...
	protected List<MessageBoardSection> messageBoardSectionList;
