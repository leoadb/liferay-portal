...
public abstract class BaseWorkflowTaskAssignableUsersResourceTestCase {
	...
	public void setUp() throws Exception {
		workflowTaskAssignableUsersList = new ArrayList<>();
	...
	public void tearDown() throws Exception {
		for (WorkflowTaskAssignableUsers workflowTaskAssignableUsers :
				workflowTaskAssignableUsersList) {
	...
	public void testPostWorkflowTaskAssignableUser() throws Exception {
		...
		workflowTaskAssignableUsersList.add(postWorkflowTaskAssignableUsers);
	...
	protected List<WorkflowTaskAssignableUsers> workflowTaskAssignableUsersList;
