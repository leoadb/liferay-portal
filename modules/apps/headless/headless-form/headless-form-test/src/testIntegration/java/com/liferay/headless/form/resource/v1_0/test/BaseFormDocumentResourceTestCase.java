...
public abstract class BaseFormDocumentResourceTestCase {
	...
	public void setUp() throws Exception {
		formDocumentList = new ArrayList<>();
	...
	public void tearDown() throws Exception {
		for (FormDocument formDocument : formDocumentList) {
			try {
	...
	public void testDeleteFormDocument() throws Exception {
		...
		formDocumentList.add(formDocument);
	...
	public void testGetFormDocument() throws Exception {
		...
		formDocumentList.add(postFormDocument);
	...
	protected List<FormDocument> formDocumentList;
